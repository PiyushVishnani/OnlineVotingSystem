	...
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
                ...
                ?>
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="tel" pattern="[0-9]{10}" name="su_contact_no" class="form-control input_pass" placeholder="Contact Number" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                                    </div>
                                    <input type="password" minlength="8" name="su_password" class="form-control input_pass" placeholder="Password" required />
                                </div>     
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center links text-white">
                                Already Created Account? <a href="index.php" class="ml-2 text-white">Login</a>
                            </div>
                        </div>
                <?php
                    }else {
                ...
                ?>
                        <span class="bg-white text-danger text-center my-3"> Passwords mismatched, enter the same password. </span>
                <?php
                    }else if(isset($_GET['not_registered'])) {
                ?>
                        <span class="bg-white text-warning text-center my-3"> Sorry, you are not registered! Please register... </span>
                <?php
                    }else if(isset($_GET['invalid_access'])) {
                ?>
                        <span class="bg-white text-danger text-center my-3"> Invalid username or password! </span>
                <?php
                    }else if(isset($_GET['alreadyexist'])){
                ?>   
                        <span class="bg-white text-danger text-center my-3"> User already exist. </span>
                <?php     
                    }
                ?>
...
<?php 
    ...
    if(isset($_POST['sign_up_btn']))
    {
        ...
        $user_role = "Voter"; 
        $query=mysqli_query($db,"SELECT contact_no FROM users WHERE contact_no='" . $su_contact_no ."' ") ;
        if(mysqli_num_rows($query)!=0){
        ?>
            <script> location.assign("index.php?sign-up=1&alreadyexist=1"); </script>
        <?php
        }
